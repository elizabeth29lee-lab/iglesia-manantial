      ...
      <header className="sticky top-0 z-50 glass-panel border-b border-earth-100/60 px-4 sm:px-8 py-4 sm:py-5 shadow-sm shadow-coffee-950/5">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-white/90 border border-earth-100 flex items-center justify-center shadow-md shadow-earth-200/35 flex-shrink-0 overflow-hidden">
              <img src="/logo.png" alt="Logo Iglesia Manantial" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="relative w-full max-w-sm aspect-[3/4] bg-white rounded-[2.2rem] p-3 shadow-2xl shadow-coffee-950/20 border border-earth-100/70 overflow-hidden">
              <div className="relative w-full h-full rounded-[1.5rem] overflow-hidden group">
                ...
                <div className="absolute bottom-3.5 left-3.5 right-3.5 bg-earth-50/90 backdrop-blur-md border border-white/60 rounded-2xl p-3 flex items-center justify-between text-xs shadow-sm">
                  ...
                  <div className="w-7 h-7 rounded-lg bg-white border border-earth-100 flex items-center justify-center flex-shrink-0 overflow-hidden">
      ...
      <footer className="mt-auto bg-coffee-950 text-coffee-300 py-12 px-4 sm:px-8 border-t border-coffee-900">
        <div className="max-w-6xl w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-white border border-coffee-800 flex items-center justify-center shadow-md shadow-coffee-950 overflow-hidden flex-shrink-0">
                <img src="/logo.png" alt="Logo" className="w-full h-full object-cover" />
              </div>
              <div className="flex flex-col leading-tight">
