        ...
        <div className="max-w-6xl w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="space-y-3 text-xs sm:text-sm">
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-green-950/20 border border-green-900/30 flex items-center justify-center text-[#25D366] group-hover:text-white group-hover:bg-[#25D366] group-hover:border-[#25D366] transition-all duration-300 shadow-sm shadow-green-950/10">
                  <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
                    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.458L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.42 9.864-9.864.002-2.637-1.023-5.115-2.887-6.979C16.578 1.898 14.1 .874 11.465.872c-5.44 0-9.863 4.42-9.867 9.864 0 1.708.455 3.376 1.314 4.869l-.955 3.486 3.568-.936zM17.5 14.92c-.29-.145-1.714-.847-1.979-.942-.266-.097-.459-.145-.653.146-.193.29-.748.942-.917 1.134-.17.193-.34.218-.63.073-.29-.145-1.229-.453-2.34-1.445-.865-.772-1.45-1.725-1.62-2.016-.17-.29-.018-.447.127-.59.13-.13.29-.339.435-.508.145-.17.193-.29.29-.483.097-.193.048-.363-.024-.508-.073-.145-.653-1.573-.895-2.153-.235-.564-.476-.488-.653-.497-.17-.008-.363-.01-.556-.01-.193 0-.508.073-.774.363-.266.29-1.015.992-1.015 2.417 0 1.425 1.038 2.802 1.182 2.996.145.193 2.043 3.12 4.95 4.378.69.299 1.23.478 1.65.612.693.22 1.324.19 1.823.115.556-.083 1.714-.7 1.956-1.378.24-.678.24-1.258.17-1.378-.07-.12-.26-.19-.55-.335z"/>
                  </svg>
                </div>
